...
class FileReader:
    ...
    @staticmethod
    def readTestFile():
        return FileReader.processing_signal("../../TestCases/Task4/DFT/Output_Signal_DFT_A,Phase.txt")

    @staticmethod
    def readTask5TestFile():
        return FileReader.processing_signal("TestCases/Task5/DCT/DCT_output.txt")